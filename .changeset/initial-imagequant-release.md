---
"@ingcreators/annot-imagequant": minor
---

Initial public release of `@ingcreators/annot-imagequant` — a small wasm-bindgen wrapper around the upstream [ImageOptim/libimagequant](https://github.com/ImageOptim/libimagequant) Rust crate (the same engine pngquant uses). Drives the PNG-8 palette quantization path in Annot's "smart" capture encoder.
