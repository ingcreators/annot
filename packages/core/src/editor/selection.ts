...
const HANDLE_SIZE = 8;
const PASTE_OFFSET = 20; // px offset when pasting
...
function pointToLocal(el: SVGElement, pt: DOMPoint, svg: SVGSVGElement): DOMPoint {
 ...
 *  SVG-root coords. */
function localToSvgPoint(el: SVGElement, p: DOMPoint, svg: SVGSVGElement): DOMPoint {
  const ctm = (el as SVGGraphicsElement).getCTM();
  const svgCTM = svg.getCTM();
...
function getWorldBBox(el: SVGElement, svg: SVGSVGElement): DOMRect | null {
