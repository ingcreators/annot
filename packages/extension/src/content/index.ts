...
import { hideStickies, restoreStickies, hideForCapture, restoreAfterCapture } from "./sticky-handler.js";
import { showProgress, hideProgress } from "./progress-overlay.js";
    ...
    switch (msg.type) {
      ...
      case "get-page-metadata":
        ...
        try {
          ...
          console.log("[annot] sending metadata:",
            meta.elements.length, "elements, captureRect:", meta.captureRect);
          sendResponse(meta);
        } catch (err) {
