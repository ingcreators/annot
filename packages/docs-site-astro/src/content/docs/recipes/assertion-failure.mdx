---
title: Annotate on assertion failure
description: Wrap a Playwright assertion in try/catch, capture the misbehaving locator with rectForBoundingBox, and attach the annotated PNG to the HTML report.
---
