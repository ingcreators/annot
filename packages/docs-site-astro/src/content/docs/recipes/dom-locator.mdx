---
title: Draw by DOM locator
description: Combine locator.boundingBox() with rectForBoundingBox + arrowBetween to draw an exact overlay rectangle anchored at a DOM element.
---
