...
- [**`createAnnotator`**](/docs/api/create-annotator) —
  factory for the headless annotator.
- [**Playwright fixture**](/docs/api/playwright-fixture) —
  the `test.extend({ annotator })` surface.
- [**Annotation DSL**](/docs/api/dsl) — typed JSON vocabulary
...
- [**Encode pipeline**](/docs/api/encode) — `format: "smart"` +
  ...
  screenshots.
- [**SVG helpers**](/docs/api/svg-helpers) — low-level fragment
