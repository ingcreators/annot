...
If you don't need MDX-linked screenshots, swap the import to
`@ingcreators/annot-playwright` — same `annot: { overlays, tags,
editable }` surface, no Astro / MDX dependency.
