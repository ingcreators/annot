...
[the xlsx-templates page](/docs/product-docs/xlsx-templates).
...
- [Concepts](/docs/product-docs/concepts) — MDX format reference.
- [Drift detection](/docs/product-docs/drift-detection) — the
  lint flow in detail.
- [Astro integration](/docs/product-docs/astro-integration) — the
  Image Service + per-component reference.
- [Xlsx templates](/docs/product-docs/xlsx-templates) — customer
