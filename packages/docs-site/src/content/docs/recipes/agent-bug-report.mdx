---
title: Agent bug-report autopilot
description: Locator-first MCP workflow — agent navigates to a staging URL, identifies a broken element, files a GitHub issue with an annotated screenshot in one conversation turn.
---
...
- [Install `annot-mcp`](/docs/ai-agents/install) into Claude
...
- [Annotation DSL](/docs/api/dsl) — the JSON shape the tools
  accept.
- [MCP tools reference](/docs/ai-agents/tools) — full schema for
