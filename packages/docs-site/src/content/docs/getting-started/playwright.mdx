---
title: Install annot-playwright
description: The Playwright fixture is the recommended entry point — drop test.extend({ annotator }) into your suite and annotate screenshots with a single call.
---
...
- [Annotate on assertion failure](/docs/recipes/assertion-failure)
- [Draw by DOM locator](/docs/recipes/dom-locator)
- [Attach to the HTML report](/docs/recipes/html-report)
