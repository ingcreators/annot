---
title: Install annot-annotator
description: Use annot-annotator directly when you want the headless renderer without Playwright — a CLI tool, a build pipeline, a CI step.
---
...
sanitisation. Output is byte-identical to what the web app produces
...
- [API reference: `createAnnotator`](/docs/api/create-annotator)
- [Playwright integration](/docs/getting-started/playwright) if you're running E2E
  tests alongside.
