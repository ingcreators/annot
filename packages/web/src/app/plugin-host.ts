...
// `UISection` / `UISectionContext` / `UISectionLifecycle` moved to
// `@ingcreators/annot-editor-shell/ui-section` in Phase 2b of
// `docs/plans/_done/vscode-extension-host.md`. Re-export keeps
// existing `import { UISection, ... } from "../app/plugin-host.js"`
...
} from "@ingcreators/annot-editor-shell/ui-section";
