...
describe("renderControl — per-category DOM golden", () => {
  it("renders the textbox category controls", () => {
    ...
    expect(renderCategory(CATEGORY_CONTROL_SHAPE.textbox, g)).toMatchInlineSnapshot(`
      ...
      <div class="pp-row"><div class="pp-row-label">Font</div><button type="button" class="pp-select" aria-label="Font" data-tooltip="Font"><span class="pp-select-preview">Sans-serif</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
