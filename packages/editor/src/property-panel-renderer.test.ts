...
describe("renderControl — per-category DOM golden", () => {
  it("renders the textbox category controls", () => {
    ...
    expect(renderCategory(CATEGORY_CONTROL_SHAPE.textbox, g)).toMatchInlineSnapshot(`
      "<div class="pp-type-row"><div class="prop-choice-chip" data-tooltip="Plain text" aria-label="Plain text"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M290-160v-540H80v-100h520v100H390v540H290Zm360 0v-340H520v-100h360v100H750v340H650Z"></path></svg></div><div class="prop-choice-chip active" data-tooltip="Sticky note" aria-label="Sticky note"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M180-180h400v-200h200v-400H180v600Zm0 60q-24.75 0-42.37-17.63Q120-155.25 120-180v-600q0-24.75 17.63-42.38Q155.25-840 180-840h600q24.75 0 42.38 17.62Q840-804.75 840-780v420L600-120H180Zm120-300v-60h170v60H300Zm0-160v-60h360v60H300ZM180-180v-600 600Z"></path></svg></div><div class="prop-choice-chip" data-tooltip="Callout" aria-label="Callout"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M80-80v-740q0-24 18-42t42-18h680q24 0 42 18t18 42v520q0 24-18 42t-42 18H240L80-80Zm134-220h606v-520H140v600l74-80Zm-74 0v-520 520Z"></path></svg></div></div>
      <div class="pp-row"><div class="pp-row-label">Color</div><button type="button" class="pp-color-btn"><span class="pp-color-swatch" style="background: #ff0000;"></span><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Font</div><button type="button" class="pp-select" aria-label="Font" data-tooltip="Font"><span class="pp-select-preview">Sans (Multilingual)</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      ...
      <div class="pp-row"><div class="pp-row-label">Bold</div><button type="button" class="pp-select" aria-label="Bold" data-tooltip="Bold"><span class="pp-select-preview">Off</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Italic</div><button type="button" class="pp-select" aria-label="Italic" data-tooltip="Italic"><span class="pp-select-preview">Off</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Underline</div><button type="button" class="pp-select" aria-label="Underline" data-tooltip="Underline"><span class="pp-select-preview">Off</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Align</div><button type="button" class="pp-select" aria-label="Align" data-tooltip="Align"><span class="pp-select-preview">Left</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">V-Align</div><button type="button" class="pp-select" aria-label="V-Align" data-tooltip="V-Align"><span class="pp-select-preview">Top</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Autofit</div><button type="button" class="pp-select" aria-label="Autofit" data-tooltip="Autofit"><span class="pp-select-preview">Do not autofit</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Margin L</div><div class="pp-number"><input type="number" min="0" max="200" step="1"><span class="pp-number-unit">px</span><div class="pp-number-spinner"><button type="button" class="pp-number-spin-up" aria-label="Increase" tabindex="-1"></button><button type="button" class="pp-number-spin-down" aria-label="Decrease" tabindex="-1"></button></div></div></div>
      <div class="pp-row"><div class="pp-row-label">Margin R</div><div class="pp-number"><input type="number" min="0" max="200" step="1"><span class="pp-number-unit">px</span><div class="pp-number-spinner"><button type="button" class="pp-number-spin-up" aria-label="Increase" tabindex="-1"></button><button type="button" class="pp-number-spin-down" aria-label="Decrease" tabindex="-1"></button></div></div></div>
      <div class="pp-row"><div class="pp-row-label">Margin T</div><div class="pp-number"><input type="number" min="0" max="200" step="1"><span class="pp-number-unit">px</span><div class="pp-number-spinner"><button type="button" class="pp-number-spin-up" aria-label="Increase" tabindex="-1"></button><button type="button" class="pp-number-spin-down" aria-label="Decrease" tabindex="-1"></button></div></div></div>
      <div class="pp-row"><div class="pp-row-label">Margin B</div><div class="pp-number"><input type="number" min="0" max="200" step="1"><span class="pp-number-unit">px</span><div class="pp-number-spinner"><button type="button" class="pp-number-spin-up" aria-label="Increase" tabindex="-1"></button><button type="button" class="pp-number-spin-down" aria-label="Decrease" tabindex="-1"></button></div></div></div>"
    `);
  });
  ...
  it("renders the marker category controls", () => {
    ...
    expect(renderCategory(CATEGORY_CONTROL_SHAPE.marker, g)).toMatchInlineSnapshot(`
      ...
      <div class="pp-row"><div class="pp-row-label">Color</div><button type="button" class="pp-color-btn"><span class="pp-color-swatch" style="background: #ff0000;"></span><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Color</div><button type="button" class="pp-color-btn"><span class="pp-color-swatch" style="background: #ffffff;"></span><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      ...
      <div class="pp-row"><div class="pp-row-label">Dash type</div><button type="button" class="pp-select" aria-label="Dash type" data-tooltip="Dash type"><span class="pp-select-preview">Solid</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
  ...
  it("renders the redact-mosaic category controls (style picker only)", () => {
    ...
    expect(renderCategory(CATEGORY_CONTROL_SHAPE["redact-mosaic"], i)).toMatchInlineSnapshot(
      `"<div class="pp-type-row"><div class="prop-choice-chip active" data-tooltip="Mosaic (pixelate)" aria-label="Mosaic (pixelate)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M179-179q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19Zm254 0q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19Zm254 0q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19ZM179-433q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19Zm254 0q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19Zm254 0q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19ZM179-687q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19Zm254 0q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19Zm254 0q-19-19-19-47t19-47q19-19 47-19t47 19q19 19 19 47t-19 47q-19 19-47 19t-47-19Z"></path></svg></div><div class="prop-choice-chip" data-tooltip="Solid bar" aria-label="Solid bar"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M80-160v-640h800v640H80Zm60-60h680v-520H140v520Zm0 0v-520 520Z"></path></svg></div><div class="prop-choice-chip" data-tooltip="Blur" aria-label="Blur"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M106-387q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Zm0-156q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Zm107 330q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-162q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-156q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-162q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm150.5 329.5Q348-379 348-402t15.5-38.5Q379-456 402-456t38.5 15.5Q456-425 456-402t-15.5 38.5Q425-348 402-348t-38.5-15.5Zm0-156Q348-535 348-558t15.5-38.5Q379-612 402-612t38.5 15.5Q456-581 456-558t-15.5 38.5Q425-504 402-504t-38.5-15.5ZM375-213q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-480q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm12 587q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Zm0-718q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Zm132.5 460.5Q504-379 504-402t15.5-38.5Q535-456 558-456t38.5 15.5Q612-425 612-402t-15.5 38.5Q581-348 558-348t-38.5-15.5Zm0-156Q504-535 504-558t15.5-38.5Q535-612 558-612t38.5 15.5Q612-581 612-558t-15.5 38.5Q581-504 558-504t-38.5-15.5ZM531-213q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-480q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm18 587q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Zm-6-718q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Zm150 611q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-162q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-156q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm0-162q-11-11-11-27t11-27q11-11 27-11t27 11q11 11 11 27t-11 27q-11 11-27 11t-27-11Zm131 306q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Zm0-156q-6-6-6-15t6-15q6-6 15-6t15 6q6 6 6 15t-6 15q-6 6-15 6t-15-6Z"></path></svg></div></div>"`,
    );
  });
  ...
  it("renders the shape category controls (rect → fill + stroke + dash)", () => {
    ...
    expect(renderCategory(CATEGORY_CONTROL_SHAPE.shape, r)).toMatchInlineSnapshot(`
      ...
      <div class="pp-row"><div class="pp-row-label">Color</div><button type="button" class="pp-color-btn"><span class="pp-color-swatch" style="background: #000000;"></span><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Transparency</div><div class="pp-number"><input type="number" min="0" max="100" step="1"><span class="pp-number-unit">%</span><div class="pp-number-spinner"><button type="button" class="pp-number-spin-up" aria-label="Increase" tabindex="-1"></button><button type="button" class="pp-number-spin-down" aria-label="Decrease" tabindex="-1"></button></div></div></div>
      ...
      <div class="pp-row"><div class="pp-row-label">Dash type</div><button type="button" class="pp-select" aria-label="Dash type" data-tooltip="Dash type"><span class="pp-select-preview">Solid</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>
      <div class="pp-row"><div class="pp-row-label">Cap type</div><button type="button" class="pp-select" aria-label="Cap type" data-tooltip="Cap type"><span class="pp-select-preview">Flat</span><span class="pp-select-caret"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M480-344 240-584l43-43 197 197 197-197 43 43-240 240Z"></path></svg></span></button></div>"
    `);
  });
