...
| [`plugin-ui-slots.md`](./plugin-ui-slots.md) | Draft | Drawer + right-panel section injection so plugins can add Cloud-style UI (comment thread, PR context, team presence). Third and final Phase-5-deferred follow-up. |
